    ...
    return (
        <div className=''>
            <div className='flex justify-between items-center max-w-screen-lg mx-auto h-24 fixed w-full  bg-slate-600 text-white rounded-b-xl'>
                <h1 className=' font-bold text-2xl capitalize p-3'>protfolio</h1>
            ...
            <div className={isOpen ? "fixed left-0 h-full w-[50%] bg-gradient-to-b from-gray-600 via-slate-600 to-black text-blue-500 z-50 transform ease-in-out duration-500 md:hidden" : "fixed left-[-100%] bg-white transform ease-out duration-500 md:hidden"}>
                <div className='mt-8 '>
